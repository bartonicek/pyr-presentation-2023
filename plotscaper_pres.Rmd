...
- These may be important for graphics: 
  - The order in which we combine should not matter
  - Accumulation should happen in one direction only (e.g. length, area, angle)

---

class: center, middle, inverse

# *"Symmetric monoidal structure on a total order"*
